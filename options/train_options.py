...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_D', type=float, default=0.0005, help='initial learning rate for the discriminator')
        ...
        parser.add_argument('--test', type=str, default="train", help='for checking mode')
